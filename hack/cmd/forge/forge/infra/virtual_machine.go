...
func (m *VirtualMachineManager) CreateOrUpdate(ctx context.Context, rgName string, desired armcompute.VirtualMachine) (*armcompute.VirtualMachine, error) {
	...
	current, err := m.getVirtualMachine(ctx, rgName, *desired.Name)
	...
	return &cuResp.VirtualMachine, nil
}

func (m *VirtualMachineManager) getVirtualMachine(ctx context.Context, rg, name string) (*armcompute.VirtualMachine, error) {
...
func (m *VirtualMachineManager) logger(name string) *slog.Logger {
