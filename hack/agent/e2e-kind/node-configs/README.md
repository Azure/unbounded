...
| `nodeExporter` | boolean | Enables node exporter inside nspawn and validates service health, host scraping, core CPU, memory, filesystem, and network metrics, node memory parity, reboot, and repave. The scenario must also provide `nodeIP`. |
