...
generate-proto:
	protoc --go_out=. --go_opt=paths=source_relative internal/net/healthcheck/proto/healthcheck.proto
	protoc --go_out=. --go_opt=paths=source_relative internal/net/status/proto/status.proto
