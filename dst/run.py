...
def reduce_artifact(args):
    ...
    try:
        ...
        if any(current.get(key) for key in ("overlap", "namespace_overlap", "checkpoint_overlap", "flight_cancellation", "local_attribution", "confirmation_admission", "zc_retirement")):
