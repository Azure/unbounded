...
// can verify the §Phase 8 contract: containerd-unreachable surfaces
...
// definitively absent and routes around). Per plan §Phase 8 "503 is
...
// OCI manifest fallback. Plan §"Descriptor and media-type handling":
