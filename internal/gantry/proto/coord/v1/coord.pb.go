...
type PullIntentResponse struct {
	...
	CooldownUntil  *timestamp.Timestamp `protobuf:"bytes,6,opt,name=cooldown_until,json=cooldownUntil,proto3" json:"cooldown_until,omitempty"`
...
func (x *PullIntentResponse) GetStartedAt() *timestamp.Timestamp {
	if x != nil {
		return x.StartedAt
	}
	return nil
...
func (x *PullIntentResponse) GetCooldownUntil() *timestamp.Timestamp {
	if x != nil {
...
type PleasePullResponse_Result struct {
	...
	StartedAt     *timestamp.Timestamp              `protobuf:"bytes,3,opt,name=started_at,json=startedAt,proto3" json:"started_at,omitempty"`
	CooldownUntil *timestamp.Timestamp              `protobuf:"bytes,4,opt,name=cooldown_until,json=cooldownUntil,proto3" json:"cooldown_until,omitempty"`
...
func (x *PleasePullResponse_Result) GetStartedAt() *timestamp.Timestamp {
	if x != nil {
		return x.StartedAt
	}
	return nil
...
func (x *PleasePullResponse_Result) GetCooldownUntil() *timestamp.Timestamp {
	if x != nil {
		return x.CooldownUntil
	}
	return nil
