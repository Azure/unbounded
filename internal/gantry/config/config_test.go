...
// Phase 8 removed the gantry-cache storage backend; Validate must
...
// An empty StorageMode is a misconfiguration after Phase 8 (NewDefault
...
// Phase 7 lease lifecycle requires positive TTL + cleanup interval.
...
// Phase 6: storage_mode=containerd requires a containerd socket. The
