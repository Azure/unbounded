...
## Historical validation status (2026-09-21, before mTLS cutover)

The record below predates the mTLS/CA-rotation fixtures. It is not evidence that
the current live deployment or rotation suite has passed.
