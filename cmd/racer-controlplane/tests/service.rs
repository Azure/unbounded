...
impl Fixture {
    ...
    fn seed(&self) {
        ...
        self.put("/apis/unbounded-cloud.io/v1alpha3/sites/edge", json!({"apiVersion":"unbounded-cloud.io/v1alpha3","kind":"Site","metadata":{"name":"edge","uid":"site"},"spec":{}}));
...
async fn service_replacement_scenario(change: &str) -> Result<()> {
    ...
    *fixture.pod_list_pause.lock().unwrap() = Some(next_sweep.clone());
    ...
    if change == "boot" {
        ...
        if change == "site" {
            fixture.put("/apis/unbounded-cloud.io/v1alpha3/sites/other", json!({"apiVersion":"unbounded-cloud.io/v1alpha3","kind":"Site","metadata":{"name":"other","uid":"other-site"},"spec":{}}));
