...
func TestBoundNodeCacheRetainsOverviewOnly(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		...
		cache.SetOnChange(func(string, *NodeStatusResponse, uint64) { fullCallbacks++ })
		cache.SetOnOverviewChange(func(_ string, overview statusv1alpha1.NodeStatusOverview, _ uint64) {
			overviewCallbacks++
