//! Standalone test crate for HTTP and its real runtime dependencies during
//! concurrent integration. No production module is replaced by a fake.
#![allow(dead_code)]
#[path = "../error.rs"]
mod error;
