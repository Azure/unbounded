...
| SDK/object interoperability and operator workload admission | SDK/operator/e2e tests | Retained Go suites with actual dataplane and object adapter; real-API operator tests; retained kind deployment suites |
...
- `racer-crosslang-test` builds the actual dataplane/object adapter for the SDK.
