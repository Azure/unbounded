...
func TestOriginWireContract(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"GET", "/page", "bytes=0-4194303", `"v1"`, 206, PageSize},
		{"GET", "/page", "bytes=4194304-4194310", `W/"v1", "other", "v1"`, 206, 7},
		{"GET", "/page", "bytes=0-4194303", "*", 206, PageSize},
		{"GET", "/page", "bytes=0-4194303", `"old"`, 412, 0},
		{"GET", "/page", "bytes=0-4194303", `W/"v1"`, 412, 0},
		{"GET", "/page", "bad", `"old"`, 412, 0}, // preconditions before ranges
		{"GET", "/page", "bytes=0-4194303", `"v1",`, 206, PageSize},
		{"GET", "/page", "bytes=0-4194303", `"v1" junk`, 400, 0},
		{"GET", "/page", "bytes=1-4", `"v1"`, 206, 4},
		{"GET", "/page", "bytes=0-4", `"v1"`, 206, 5},
		{"GET", "/page", "bytes=0-4194310", `"v1"`, 206, int64(len(data))},
