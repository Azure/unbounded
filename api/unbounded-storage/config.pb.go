...
type Config struct {
	...
	DiskPools     []*DiskPoolSpec     `protobuf:"bytes,7,rep,name=disk_pools,json=diskPools,proto3" json:"disk_pools,omitempty"`
...
func (x *Config) GetDiskPools() []*DiskPoolSpec {
	if x != nil {
		return x.DiskPools
	}
	return nil
...
type CacheSpec struct {
	...
	Name   string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Source string                 `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty"`
	// Disk pool used by this cache.
	DiskPool      string `protobuf:"bytes,3,opt,name=disk_pool,json=diskPool,proto3" json:"disk_pool,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CacheSpec) GetDiskPool() string {
	if x != nil {
		return x.DiskPool
	}
	return ""
...
type DiskPoolSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Name  string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Disk definitions in this pool.
	Disks         []*DiskSpec `protobuf:"bytes,2,rep,name=disks,proto3" json:"disks,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DiskPoolSpec) Reset() {
	*x = DiskPoolSpec{}
...
func (x *DiskPoolSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DiskPoolSpec) ProtoMessage() {}

func (x *DiskPoolSpec) ProtoReflect() protoreflect.Message {
	mi := &file_config_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DiskPoolSpec.ProtoReflect.Descriptor instead.
func (*DiskPoolSpec) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{16}
}

func (x *DiskPoolSpec) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *DiskPoolSpec) GetDisks() []*DiskSpec {
	if x != nil {
		return x.Disks
	}
	return nil
...
type BlockDiskConfig struct {
	...
	// Block device path; paths must be unique across all disk pools.
...
type FileDiskConfig struct {
	...
	// Backing-file path; paths must be unique across all disk pools.
	Path          string `protobuf:"bytes,2,opt,name=path,proto3" json:"path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_config_proto_rawDesc = "" +
	"\n" +
	"\fconfig.proto\x12\x18unbounded.storage.config\"\xc1\x03\n" +
	"\x06Config\x12\x18\n" +
	...
	"\rneighborhoods\x18\x06 \x03(\v2*.unbounded.storage.config.NeighborhoodSpecR\rneighborhoods\x12E\n" +
	"\n" +
	"disk_pools\x18\a \x03(\v2&.unbounded.storage.config.DiskPoolSpecR\tdiskPools\"\x89\x02\n" +
	"\n" +
	"StartupCfg\x12;\n" +
	...
	"\x04addr\x18\x01 \x01(\tR\x04addr\"T\n" +
	"\tCacheSpec\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x12\x1b\n" +
	"\tdisk_pool\x18\x03 \x01(\tR\bdiskPool\"\\\n" +
	"\fDiskPoolSpec\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x128\n" +
	"\x05disks\x18\x02 \x03(\v2\".unbounded.storage.config.DiskSpecR\x05disks\"\xbc\x02\n" +
	"\bDiskSpec\x12$\n" +
...
var file_config_proto_goTypes = []any{
	...
	(*DiskPoolSpec)(nil),          // 16: unbounded.storage.config.DiskPoolSpec
...
var file_config_proto_depIdxs = []int32{
	...
	16, // 5: unbounded.storage.config.Config.disk_pools:type_name -> unbounded.storage.config.DiskPoolSpec
	...
	17, // 18: unbounded.storage.config.DiskPoolSpec.disks:type_name -> unbounded.storage.config.DiskSpec
