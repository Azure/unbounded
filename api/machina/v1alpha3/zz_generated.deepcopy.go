...
func (in *GantrySnapshotterComponentSpec) DeepCopyInto(out *GantrySnapshotterComponentSpec) {
	*out = *in
	...
	if in.CatalogSize != nil {
		in, out := &in.CatalogSize, &out.CatalogSize
		x := (*in).DeepCopy()
		*out = &x
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GantrySnapshotterComponentSpec.
func (in *GantrySnapshotterComponentSpec) DeepCopy() *GantrySnapshotterComponentSpec {
	if in == nil {
		return nil
	}
	out := new(GantrySnapshotterComponentSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SiteComponents) DeepCopyInto(out *SiteComponents) {
	*out = *in
	...
	if in.GantrySnapshotter != nil {
		in, out := &in.GantrySnapshotter, &out.GantrySnapshotter
		*out = new(GantrySnapshotterComponentSpec)
		(*in).DeepCopyInto(*out)
	}
}
