...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PXEInstallSpec) DeepCopyInto(out *PXEInstallSpec) {
	*out = *in
	if in.TargetDisks != nil {
		in, out := &in.TargetDisks, &out.TargetDisks
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PXEInstallSpec.
func (in *PXEInstallSpec) DeepCopy() *PXEInstallSpec {
	if in == nil {
		return nil
	}
	out := new(PXEInstallSpec)
	in.DeepCopyInto(out)
	return out
}
